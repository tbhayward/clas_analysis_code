...
public class Dipion {
    ...
    public static boolean channel_test(Dipion variables) {
...
//        else if (variables.z()>0.95) { return false; } 
...
//        else if (variables.xF2()<0.0) { return false; } 
    ...
    public Dipion(DataEvent event, PhysicsEvent recEvent, int p1PID, int p1Index, int p2PID, int p2Index) {
